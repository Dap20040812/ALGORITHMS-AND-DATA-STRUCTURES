...
public class HuffmanDecoding {
    ...
    static class HuffmanLeaf extends HuffmanDecoding.Node {
    ...
    static class HuffmanNode extends HuffmanDecoding.Node {
    ...
    public static Node buildTree(int[] charFreqs) {
        ...
        for (int i = 0; i < charFreqs.length; i++)
            if (charFreqs[i] > 0)
                trees.offer(new HuffmanDecoding.HuffmanLeaf(charFreqs[i], (char) i));
